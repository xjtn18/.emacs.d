;;; jake_wheatgrass-theme.el --- custom theme for faces
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   'jake_wheatgrass
   `(default ((,class (:foreground "wheat" :background "gray10"))))
   ...
   `(font-lock-comment-face ((,class (:foreground "aquamarine4"))))
...
(provide-theme 'jake_wheatgrass)

;;; jake_wheatgrass-theme.el ends here
