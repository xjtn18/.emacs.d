;;; jake-leuven-theme.el --- Awesome Emacs color theme on white background
...
(let ((class '((class color) (min-colors 89)))
      ...
      (directory '(:weight bold :foreground "blue" :background "white"))
  ...
  (custom-theme-set-faces
   ...
   `(minibuffer-prompt ((,class (:weight bold :foreground "black" :background "white"))))
   `(minibuffer-noticeable-prompt ((,class (:weight bold :foreground "black" :background "white"))))
...
(custom-theme-set-variables 'jake-leuven
...
;;; jake-leuven-theme.el ends here
